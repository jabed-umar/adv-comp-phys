...
def monte_carlo_integration(a: float, b: float, n: int, seed: int, a_lcg: int, c_lcg: int, m_lcg: int = 2**32):
    '''
    ...
    '''
    random_numbers = lcg(seed, a_lcg, c_lcg, n, m_lcg)
    integral = 0
    for i in random_numbers:
        integral += np.cos(a + (b-a)*i)
